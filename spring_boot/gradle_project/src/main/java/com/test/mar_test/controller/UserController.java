...
import com.test.mar_test.Configuration.AppConstants;
import com.test.mar_test.Request.LoginRequest;
import com.test.mar_test.Request.RegisterRequest;
import com.test.mar_test.Response.ErrorResponse;
import com.test.mar_test.Response.LoginResponse;
import com.test.mar_test.Service.HomeService;
...
//    }
    ...
    public ResponseEntity getUser(){
        try{
           return ResponseEntity.badRequest().body("Eror in request");//response with obj
           // userService.checkTokenForUserId(user_id,token);
